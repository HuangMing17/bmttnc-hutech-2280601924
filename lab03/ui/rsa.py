...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(340, 30, 411, 121))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(0, 390, 131, 121))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_4.setGeometry(QtCore.QRect(550, 140, 131, 121))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_5.setGeometry(QtCore.QRect(540, 380, 131, 121))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(150, 660, 93, 51))
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.txt_plain_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(100, 220, 371, 161))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(320, 660, 93, 51))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(770, 650, 93, 51))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(950, 650, 93, 51))
        self.btn_verify.setObjectName("btn_verify")
        self.txt_inf = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_inf.setGeometry(QtCore.QRect(680, 220, 371, 161))
        self.txt_inf.setObjectName("txt_inf")
        self.txt_sign = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(690, 470, 371, 161))
        self.txt_sign.setObjectName("txt_sign")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(100, 470, 371, 161))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.btn_gen_keys = QtWidgets.QPushButton(self.centralwidget)
        self.btn_gen_keys.setGeometry(QtCore.QRect(600, 110, 311, 51))
