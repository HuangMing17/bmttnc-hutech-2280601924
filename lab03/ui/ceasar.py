...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(60, 90, 120, 30))
        self.label.setObjectName("label")

        # Label - Key
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(60, 200, 120, 30))
        self.label_2.setObjectName("label_2")

        # Label - CipherText
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(60, 300, 120, 30))
        self.label_3.setObjectName("label_3")

        # PlainTextEdit - Input PlainText
        self.txt_plain = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain.setGeometry(QtCore.QRect(180, 90, 500, 80))
        self.txt_plain.setObjectName("txt_plain")

        # PlainTextEdit - Input Key
        self.txt_key = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(180, 200, 200, 40))
        self.txt_key.setObjectName("txt_key")

        # PlainTextEdit - Output CipherText
        self.txt_cipher = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher.setGeometry(QtCore.QRect(180, 300, 500, 80))
        self.txt_cipher.setObjectName("txt_cipher")

        # Button - Encrypt
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(180, 420, 120, 50))
        self.btn_encrypt.setObjectName("btn_encrypt")

        # Button - Decrypt
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(360, 420, 120, 50))
